...
import img1 from "../assets/1.jpg"; // Replace with the correct path
    ...
    <section className="py-16 px-8">
      <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="lg:w-1/2 text-left">
          <h2 className="text-4xl sm:text-6xl font-extrabold text-gray-800 leading-tight mb-6">
            Ever Wonder Who's
            <br />
            Creating All This
            <br />
          ...
          <p className="mt-6 text-lg sm:text-2xl text-gray-700 max-w-lg">
          ...
          {[
            ...
            >
              ...
              <div className="mt-4">
                ...
                <p className="mt-2 text-gray-800">{member.role}</p>
              </div>
